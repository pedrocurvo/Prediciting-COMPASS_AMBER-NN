...
for epoch in tqdm(range(EPOCHS)):
    ...
    if epoch % 1 == 0:
        ...
        df = df._append({'epoch': epoch, 'train_loss': loss.item(), 'test_loss': test_loss.item(), 'train_acc': acc, 'test_acc': test_acc, 'chi_squared': chi_squared(y_test, test_pred, X_test)}, ignore_index=True)
